...
const HeroProject = (props) => {
    ...
    return (
        ...
        <div className="h-screen flex flex-row justify-center mx-auto text-center">

            <div className="flex flex-col justify-center mx-auto text-center w-1/2">
                <h1 className="text-7xl text-pBlue-2 font-bold tracking-widest font-main mt-8 uppercase">{props.header}</h1>
