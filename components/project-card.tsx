const ProjectCard = (props) => {
    ...
    return (
        <div className="card my-6 px-6 w-full overflow-hidden lg:w-5/12 xl:w-5/12 rounded shadow-lg bg-deepBlue-1">
            ...
            <div className="px-6 py-4 ">
                <div className="font-bold text-2xl mb-2 text-center uppercase tracking-widest text-pBlue-3">
                    {props.name}
                </div>
