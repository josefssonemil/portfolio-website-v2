...
export default function Home() {
  return (
    ...
    <Header/>
      ...
      <h1 className="heading text-4xl font-bold text-auth-text text-center lg:text-left font-red-main mt-24 ">Selected work</h1>
      ...
      <ProjectSection
          ...
          {/* 
          <div className="flex flex-col lg:flex-row mx-auto lg:justify-center items-center">
